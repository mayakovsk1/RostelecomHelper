...
def key_words(text):
    stopwords = ['как', 'куда', 'сегодня', 'я', 'он', 'она', 'они', 'лагать', 'работать', 'вчера', 'скоро', 'мало',
                 'много', 'что', 'делать', 'какое', 'или', 'и', 'от', 'в', 'на', 'нас', 'вас', 'их', 'какими', 'это',
                 'не', 'то', 'нет', 'какой', 'почему', 'помогите', 'здравствуйте', 'всё', 'возможность', 'возможно',
                 'с', 'со', 'свой', 'мой', 'могут', 'ли', 'можно', 'могут', 'может', 'для', 'при', 'за', 'по', 'но',
                 'к', 'но', 'проблема', 'узнать', 'такой', 'если', 'о', 'из']
